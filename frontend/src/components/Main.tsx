...
export function Main() {
  ...
  return (
    <>
      <header className="py-5 flex items-center justify-center bg-gray-700 border-b border-gray-600 mobile:justify-between mobile:p-2 mobile:min-w-[360px] mobile:w-[100%]">
        <Logo />
